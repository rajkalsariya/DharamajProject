...
@section('frontend')
    ...
    @php
    $matrimonys = DB::table('matrimonies')
        ->latest()
        ->paginate(5);
    @endphp
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="city_event2_fig">
                            <figure class="box" style="height: 255px;">
                                ...
                                <img src="{{ asset($matrimony->photourl) }}"
                                    style="filter: blur(8px); -webkit-filter: blur(8px);" alt="">
                            </figure>
                            <div class="city_event2_list">
                                ...
                                <div class="city_event2_text">
                                    ...
                                    <h4><a
                                            href="{{ url('/service/matrimony/details/' . $matrimony->id) }}">{{ $matrimony->name }}</a>
                                    </h4>
                                </div>
