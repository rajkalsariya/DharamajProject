                ...
                <div class="main_bottom_left">
                    <div class="main_bottom_content">
                        <div class="author_image">
                            <img src="{{ asset($services->logo) }}" width="150" alt="">
                        </div>
                    </div>
                    <div class="main_bottom_left_title">
                        <h3>{{ $services->title }}<i class="fa fa-check"></i></h3>
                    </div>
                    <div class="main_bottom_rating_time">
                        ...
                        <div class="main_bottom_time">
                            <p><span class="far fa-clock"></span>Posted {{ Carbon\Carbon::parse($services->created_at)->diffForHumans() }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-8">
                <div class="listings_details_left">
                    <div class="listings_details_text">
                        <p class="first_text">{!! $services->description !!}</p>
                    </div>
                        ...
                        <div class="contact_info">
                            <ul class="list-unstyled contact_info_list">
                                <li>
                                    ...
                                    <span style="display: inline-block; width: 90%; vertical-align: top;">{{ $services->adder1 }}, {{ $services->adder2 }}, {{ $services->city }}, {{ $services->pincode }}</span>
                                </li>
                                <li><a href="tel:+{{ $services->contact1 }}"><i class="fa fa-phone"></i>{{ $services->contact1 }}</a></li>
                                <li><a href="tel:+{{ $services->contact2 }}"><i class="fa fa-phone"></i>{{ $services->contact2 }}</a></li>
                                <li><a href="mailto:{{ $services->email }}"><i class="fas fa-envelope"></i>{{ $services->email }}</a></li>
                                <li><a href="//{{ $services->website }}" target="_blank"><i class="fas fa-globe"></i>{{ $services->website }}</a>
                                </li>
                            </ul>
