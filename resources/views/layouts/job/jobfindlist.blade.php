    ...
    <div class="col-lg-12">
        <section class="card">
            <header class="card-header">
                ...
                <h2 class="card-title">Job Find List</h2>
            </header>
            <div class="card-body">
                <table class="table table-bordered table-striped mb-0" id="jobFindListDataTable">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Contact No.</th>
        ...
        <div class="card-body">
            <div class="modal-wrapper">
                ...
                <div class="modal-text">
                    <p class="mb-0">Are you sure !! you want to delete this Job Find?</p>
                </div>
            </div>
        </div>
...
<div id="editModel" class="zoom-anim-dialog modal-block modal-block-full mfp-hide">
    <section class="card">
        <header class="card-header">
            <h2 class="card-title">Edit Job Find
        ...
        <div class="card-body" id="editProduct">
            ...
            <div class="card-body">
                    <div class="form-group row">
                        <div class="col-sm-6">
                            <label id="nameTitle" class="control-label text-sm-right pt-2">Name <span class="required">*</span></label>
                        ...
                        <div class="col-sm-6 pt-2">
                            <label class="control-label">Select Resume <span class="required">*</span></label>
                            <div class="row">
                                <div class="col-sm-10">
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="input-append">
                                                ...
                                                <span class="btn btn-default btn-file">
                                                    ...
                                                    <input class="image" name="resume" id="resume" type="file" />
                                                </span>
        ...
        <footer class="card-footer">
            <div class="row">
                <div class="col-md-12 text-right">
                    <input type="hidden" id="jobfindID" />
                    <input type="hidden" id="oldImg" />
                    <button class="btn btn-danger modal-update" id="updateJobFind">Update</button>
                    <button class="btn btn-default modal-dismiss" id="cancel">Cancel</button>
                </div>
            </div>
        </footer>
...
<script src="{{ asset('admin/custom/jobfind.js') }}"></script>
